...
@Entity
@Table(name = "SSCC_ESTADO", catalog = DataBaseShemaConf.SCHEMANML)
public class SsccEstado implements Serializable {
    private static final long serialVersionUID = -7816557022810756087L;
    @Id
    ...
    @Size(max = 35)
    @Column(name = "REF_NOM_ESTADO", length = 35)
    ...
    public String getRefNomEstado() {
        return refNomEstado;
    }

    public void setRefNomEstado(String refNomEstado) {
        this.refNomEstado = refNomEstado;
    }
